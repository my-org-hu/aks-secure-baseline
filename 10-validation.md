...
1. Get Public IP of Application Gateway
   ...
   export APPGW_PUBLIC_IP=$(az deployment group show --resource-group rg-enterprise-networking-spokes -n $spokes --query properties.outputs.appGwPublicIpAddress.value -o tsv)
   ```
